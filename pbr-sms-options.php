...
if ( current_user_can( 'manage_options' ) ) {
	...
	function pbr_sms_menu() {
		...
		add_submenu_page(
			'tools.php',
			__( 'WP SMS Notfications', 'pbr-sms-notifications' ),
			__( 'WP SMS Notifications', 'pbr-sms-notifications' ),
			'manage_options',
	...
	function pbr_sms_notifications_menu() {
		...
		<div class="wrap">
			...
			<div style="margin-left:auto; float:right;">
				...
				<p><a href="https://jeffmatson.net/pbr-sms/">Upgrade to WP SMS Notifications Pro</a> today!</p>
